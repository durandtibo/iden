...
|---------|-----------------|--------------|---------------------|----------------------|---------------------------|---------------------|---------------|
| `main`  | `>=1.1,<2.0`    | `>=0.3,<1.0` | `>=1.24,<3.0`       | `>=6.0,<7.0`         | `>=0.6,<1.0`              | `>=2.0,<3.0`        | `>=3.10`      |
| `0.4.1` | `>=1.1,<2.0`    | `>=0.3,<1.0` | `>=1.24,<3.0`       | `>=6.0,<7.0`         | `>=0.6,<1.0`              | `>=2.0,<3.0`        | `>=3.10`      |
| `0.4.0` | `>=1.0,<2.0`    | `>=0.3,<1.0` | `>=1.24,<3.0`       | `>=6.0,<7.0`         | `>=0.6,<1.0`              | `>=2.0,<3.0`        | `>=3.10`      |
| `0.3.0` | `>=0.11.0,<1.0` | `>=0.3,<1.0` | `>=1.24,<3.0`       | `>=6.0,<7.0`         | `>=0.6,<1.0`              | `>=2.0,<3.0`        | `>=3.10`      |
| `0.2.0` | `>=0.8.4,<1.0`  | `>=0.2,<1.0` | `>=1.22,<3.0`       | `>=6.0,<7.0`         | `>=0.4,<1.0`              | `>=2.0,<3.0`        | `>=3.9,<3.14` |
| `0.1.0` | `>=0.8.4,<1.0`  | `>=0.2,<1.0` | `>=1.22,<3.0`       | `>=6.0,<7.0`         | `>=0.4,<1.0`              | `>=2.0,<3.0`        | `>=3.9,<3.14` |

| `iden`  | `cloudpickle`<sup>*</sup> | `joblib`<sup>*</sup> |
|---------|---------------------------|----------------------|
| `main`  | `>=3.0,<4.0`              | `>=1.3,<2.0`         |
| `0.4.1` | `>=3.0,<4.0`              | `>=1.3,<2.0`         |
