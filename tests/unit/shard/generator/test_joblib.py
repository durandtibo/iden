...
@joblib_available
def test_joblib_shard_generator_equal_true(tmp_path: Path) -> None:
    generator1 = JoblibShardGenerator(
        data=DataGenerator([1, 2, 3]),
        path_uri=tmp_path.joinpath("uri"),
        path_shard=tmp_path.joinpath("shard"),
    )
    generator2 = JoblibShardGenerator(
        data=DataGenerator([1, 2, 3]),
        path_uri=tmp_path.joinpath("uri"),
        path_shard=tmp_path.joinpath("shard"),
    )
...
@joblib_available
def test_joblib_shard_generator_equal_false_different_data(tmp_path: Path) -> None:
    generator1 = JoblibShardGenerator(
        data=DataGenerator([1, 2, 3]),
        path_uri=tmp_path.joinpath("uri"),
        path_shard=tmp_path.joinpath("shard"),
...
@joblib_available
def test_joblib_shard_generator_equal_false_different_path_uri(tmp_path: Path) -> None:
    generator1 = JoblibShardGenerator(
        data=DataGenerator([1, 2, 3]),
        path_uri=tmp_path.joinpath("uri"),
        path_shard=tmp_path.joinpath("shard"),
...
@joblib_available
def test_joblib_shard_generator_equal_false_different_path_shard(tmp_path: Path) -> None:
    generator1 = JoblibShardGenerator(
        data=DataGenerator([1, 2, 3]),
        path_uri=tmp_path.joinpath("uri"),
        path_shard=tmp_path.joinpath("shard"),
...
@joblib_available
def test_joblib_shard_generator_equal_false_different_type(tmp_path: Path) -> None:
...
@joblib_available
def test_joblib_shard_generator_equal_false_different_type_child(tmp_path: Path) -> None:
    class Child(JoblibShardGenerator): ...
...
@joblib_available
def test_joblib_shard_generator_equal_true_equal_nan(tmp_path: Path) -> None:
    generator1 = JoblibShardGenerator(
...
@joblib_available
def test_joblib_shard_generator_equal_false_equal_nan(tmp_path: Path) -> None:
    generator1 = JoblibShardGenerator(
        data=DataGenerator([1, 2, 3, float("nan")]),
        path_uri=tmp_path.joinpath("uri"),
        path_shard=tmp_path.joinpath("shard"),
